...
towtSpawns = gameplayVariables.twotspawns
patriotSpawns = gameplayVariables.patriotspawns
copSpawns = gameplayVariables.copspawns
reginaSpawns = gameplayVariables.reginaspawns
camionSpawns = gameplayVariables.camionspawns
remorqueSpawns = gameplayVariables.remorquespawns
tractorSpawns = gameplayVariables.tractorspawns
dodoSpawns = gameplayVariables.dodospawns
...
cargobobSpawns = gameplayVariables.cargobobspawns
...
function spawnDayZVehicles()
  ...
  for i, veh in ipairs(pickupSpawns) do
    ...
    setElementHealth(veh, math.random(300,400))
    setVehicleDoorState(veh, 0, math.random(1, 3))
    setVehicleDoorState(veh, 1, math.random(1, 3))
    setVehicleDoorState(veh, 2, math.random(1, 3))
    setVehicleDoorState(veh, 3, math.random(1, 3))
    setVehicleDoorState(veh, 4, math.random(1, 3))
    setVehicleDoorState(veh, 5, math.random(1, 3))
    local value_1468 = math.random(1,3)
    if value_1468 == 1 then
      setVehiclePlateText(veh, "MTA")
    end
    if value_1468 == 2 then
      setVehiclePlateText(veh, "DAYZ")
    end
    if value_1468 == 3 then
      setVehiclePlateText(veh, "EPOCH")
    end
  ...
  for i, veh in ipairs(towtSpawns) do
    local x, y, z = veh[1], veh[2], veh[3]
 ...
 for i, veh in ipairs(quadSpawns) do
  ...
  for i, veh in ipairs(camperSpawns) do
    ...
    setElementData(veh, "parent", vehCol)
    setElementData(vehCol, "vehicle", true)
    setElementData(vehCol, "MAX_Slots", 22)
    local tires, engine, parts = getVehicleAddonInfos(getElementModel(veh))
    setElementData(vehCol, "Tire_inVehicle", math.random(0, tires))
    setElementData(vehCol, "Engine_inVehicle", math.random(0, engine))
    setElementData(vehCol, "Parts_inVehicle", math.random(0, parts))
  ...
  for i, veh in ipairs(copSpawns) do
    local x, y, z = veh[1], veh[2], veh[3]
  ...
  for i, veh in ipairs(dodoSpawns) do
    local x, y, z = veh[1], veh[2], veh[3]
  ...
  for i, veh in ipairs(reginaSpawns) do
    ...
    setElementData(veh, "parent", vehCol)
    setElementData(vehCol, "vehicle", true)
    setElementData(vehCol, "MAX_Slots", 55)
    local tires, engine, parts = getVehicleAddonInfos(getElementModel(veh))
    setElementData(vehCol, "Tire_inVehicle", math.random(0, tires))
    setElementData(vehCol, "Engine_inVehicle", math.random(0, engine))
    setElementData(vehCol, "Parts_inVehicle", math.random(0, parts))
  ...
  for i, veh in ipairs(camionSpawns) do
    local x, y, z = veh[1], veh[2], veh[3]
    veh = createVehicle(515, x, y, z)
    vehCol = createColSphere(x, y, z, 2.5)
    attachElements(vehCol, veh, 0, 0, 0)
    setElementHealth(veh, math.random(300,400))
    setVehicleDoorState(veh, 0, math.random(1, 3))
  ...
  for i, veh in ipairs(remorqueSpawns) do
    local x, y, z = veh[1], veh[2], veh[3]
    veh = createVehicle(435, x, y, z)
    vehCol = createColSphere(x, y, z, 3.5)
    attachElements(vehCol, veh, 0, 0, 0)
    setElementData(vehCol, "parent", veh)
    setElementData(veh, "parent", vehCol)
    setElementData(vehCol, "vehicle", true)
    setElementData(vehCol, "MAX_Slots", 230)
    local tires, engine, parts = getVehicleAddonInfos(getElementModel(veh))
    setElementData(vehCol, "Tire_inVehicle", math.random(0, tires))
    setElementData(vehCol, "Engine_inVehicle", math.random(0, engine))
    setElementData(vehCol, "Parts_inVehicle", math.random(0, parts))
  ...
  for i, veh in ipairs(cargobobSpanws) do
    local x, y, z = veh[1], veh[2], veh[3]
    veh = createVehicle(417, x, y, z)
    vehCol = createColSphere(x, y, z, 1.5)
    attachElements(vehCol, veh, 0, 0, 0)
    --setElementHealth(veh, 660)
    setElementData(vehCol, "parent", veh)
    setElementData(veh, "parent", vehCol)
    setElementData(vehCol, "vehicle", true)
    setElementData(vehCol, "MAX_Slots", 8)
  ...
  setElementData(vehCol, "Tire_inVehicle", math.random(0, tires))
  setElementData(vehCol, "Engine_inVehicle", math.random(0, engine))
  setElementData(vehCol, "Parts_inVehicle", math.random(1, parts))
  setElementData(vehCol, "spawn", {
    487,
    x,
    y,
...
function isVehicleReadyToStart2(veh)
  if getElementData(getElementData(veh, "parent"), "fuel") >= 1 then
    local tires, engine, parts = getVehicleAddonInfos(getElementModel(veh))
    if (getElementData(getElementData(veh, "parent"), "Tire_inVehicle") or 0) > tonumber(tires) then
      if (getElementData(getElementData(veh, "parent"), "Engine_inVehicle") or 0) > tonumber(engine) then
        setVehicleEngineState(veh, true)
      end
    end
  end

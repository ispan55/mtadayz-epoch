...
function meleeShoot(ped)
    if (isElement(ped)) then
        ...
        setPedControlState ( ped, "WOMAN_walkshop", false )
        ...
        setTimer ( function (ped) if ( isElement ( ped ) ) then setPedControlState ( ped, "WOMAN_walkshop", true) end end, 2000, 1, ped )
    end
end
...
function Bforward ()
    if (isElement(source)) then
        ...
        setPedControlState ( source, "WOMAN_walkshop", true )
    end
end
...
function Bstop ( )
    if (isElement(source)) then
        ...
        setPedControlState ( source, "WOMAN_walkshop", false )
    end
end

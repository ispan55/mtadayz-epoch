...
--   dxDrawText(""..money.." €", screenWidth*0.887, screenHeight*0.157, screenWidth*0.988, screenHeight*0.194, tocolor(35, 98, 36, 255), 1, "default", "left", "top", false, false, false, false, false)
   ...
   if ( arma==8 ) then destroyElement(element1)element1 = dxDrawText(" Hatchet ", screenWidth*0.845, screenHeight*0.024, screenWidth*0.978, screenHeight*0.59, tocolor(23, 112, 31, 255), 1.50, "sans", "left", "top", false, false, false, false, false)end

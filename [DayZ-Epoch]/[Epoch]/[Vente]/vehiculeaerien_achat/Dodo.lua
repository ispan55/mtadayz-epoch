function VenteDayZPDodo(thePlayer)
      local x, y, z = getElementPosition(thePlayer)
      veh = createVehicle(593, 1921.7580566406,-2250.1833496094,15.1484375)
      ...
      setElementData(vehCol, "Tire_inVehicle", 3)
...
addEvent("VenteDayZPDodo", true)
addEventHandler("VenteDayZPDodo", root, VenteDayZPDodo)

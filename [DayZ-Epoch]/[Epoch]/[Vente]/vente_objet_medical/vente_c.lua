...
addEventHandler("onClientResourceStart", resourceRoot,
    function()
        ...
        GUIEditor.button[2] = guiCreateButton(10, 147, 77, 34, "Bandage        +5$", false, GUIEditor.window[1])
        ...
        GUIEditor.button[3] = guiCreateButton(102, 147, 77, 34, "Medic Kit          +10$", false, GUIEditor.window[1])
        ...
        GUIEditor.button[4] = guiCreateButton(196, 147, 77, 34, "Blood Bag   +20$", false, GUIEditor.window[1])
        ...
        GUIEditor.button[5] = guiCreateButton(290, 147, 77, 34, "Morphine  +10$", false, GUIEditor.window[1])
...
Mark = {
{-2119.0581054688,-142.23249816895,35.3203125},
{2828.3469238281,1282.6876220703,10.769868850708},
}
--Blip
...
triggerServerEvent("VenteBandage",getLocalPlayer()) 
end 
end)
addEventHandler ("onClientGUIClick", getRootElement(), 
function(button, state, absoluteX, absoluteY)
if ( source ==  GUIEditor.button[3] ) then 
triggerServerEvent("VenteMkit",getLocalPlayer()) 
end 
end)
addEventHandler ("onClientGUIClick", getRootElement(), 
function(button, state, absoluteX, absoluteY)
if ( source ==  GUIEditor.button[4] ) then 
triggerServerEvent("VenteBoodbag",getLocalPlayer()) 
end 
end)
...
triggerServerEvent("VenteMorphine",getLocalPlayer()) 
end 
end)
addEventHandler ("onClientGUIClick", getRootElement(), 
function(button, state, absoluteX, absoluteY)
if ( source ==  GUIEditor.button[6] ) then 
triggerServerEvent("VentePainkiller",getLocalPlayer()) 
end 
end)

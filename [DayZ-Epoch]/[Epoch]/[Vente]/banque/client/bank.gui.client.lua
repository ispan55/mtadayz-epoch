...
addEventHandler( "onClientResourceStart", g_this_root, 
	...
	if theResource == getThisResource() then 
			...
			tempLbl = guiCreateLabel( 0.08, 0.12, 1, 1, "Nom de compte :", true, bankWnd )
			...
			tempLbl = guiCreateLabel( 0.08, 0.24, 1, 1, "Balance actuel :", true, bankWnd )
				guiSetFont( tempLbl, "default-bold-small" )
			...
			withdrawTab = { }
			withdrawTab.tab = guiCreateTab( "Retirer", tabPanel )
			withdrawTab.amount_lbl = guiCreateLabel( 0.03, 0.09, 1, 1, "Montant:", true, withdrawTab.tab )
			...
			withdrawTab.button = guiCreateButton( 0.018, 0.71, 0.45, 0.25, "retirer", true, withdrawTab.tab )
				guiSetFont( withdrawTab.button, "default-bold-small" )
			withdrawTab.withdrawall_button = guiCreateButton( 0.498, 0.71, 0.48, 0.25, "retirer tout", true, withdrawTab.tab )
			...
			depositTab = { }
			depositTab.tab = guiCreateTab( "Déposer", tabPanel )
			depositTab.amount_lbl = guiCreateLabel( 0.03, 0.09, 1, 1, "Montant:", true, depositTab.tab )
			...
			depositTab.button = guiCreateButton( 0.018, 0.71, 0.45, 0.25, "déposer", true, depositTab.tab )
				guiSetFont( depositTab.button, "default-bold-small" )
			depositTab.depositall_button = guiCreateButton( 0.498, 0.71, 0.48, 0.25, "déposer tout", true, depositTab.tab )
			...
			transferTab = { }
			transferTab.tab = guiCreateTab( "Tranférer", tabPanel )
			transferTab.to_lbl = guiCreateLabel( 0.03, 0.09, 1, 1, "A:", true, transferTab.tab )
			...
			transferTab.amount_lbl = guiCreateLabel( 0.03, 0.41, 1, 1, "Montant:", true, transferTab.tab )
			...
			transferTab.button = guiCreateButton( 0.018, 0.71, 0.45, 0.25, "Tranférer", true, transferTab.tab )
				guiSetFont( transferTab.button, "default-bold-small" )
			transferTab.transferall_button = guiCreateButton( 0.498, 0.71, 0.48, 0.25, "Tranférer tout", true, transferTab.tab )
			...
			quit_btn = guiCreateButton( 0.5, 0.87, 0.5, 0.2, "Quitter", true, bankWnd )

function VenteDayZBarracksLV(thePlayer)
      local x, y, z = getElementPosition(thePlayer)
      veh = createVehicle(433, 2820.4860839844,1318.1414794922,10.758351325989)
...
addEvent("VenteDayZBarracksLV", true)
addEventHandler("VenteDayZBarracksLV", root, VenteDayZBarracksLV)

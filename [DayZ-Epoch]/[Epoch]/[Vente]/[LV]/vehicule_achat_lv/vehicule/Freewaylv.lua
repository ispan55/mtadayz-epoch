function VenteDayZFreewayLV(thePlayer)
      local x, y, z = getElementPosition(thePlayer)
      veh = createVehicle(463, 2820.4860839844,1318.1414794922,10.758351325989)
...
addEvent("VenteDayZFreewayLV", true)
addEventHandler("VenteDayZFreewayLV", root, VenteDayZFreewayLV)

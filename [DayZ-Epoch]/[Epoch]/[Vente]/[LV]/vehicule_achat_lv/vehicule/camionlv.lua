function VenteDayZCamionLV(thePlayer)
      local x, y, z = getElementPosition(thePlayer)
      veh = createVehicle(515, 2820.4860839844,1318.1414794922,15.758351325989)
      vehCol = createColSphere(2820.4860839844,1318.1414794922,15.758351325989, 4)
...
addEvent("VenteDayZCamionLV", true)
addEventHandler("VenteDayZCamionLV", root, VenteDayZCamionLV)

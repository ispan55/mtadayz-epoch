function VenteDayZCloverLV(thePlayer)
      local x, y, z = getElementPosition(thePlayer)
      veh = createVehicle(542, 2820.4860839844,1318.1414794922,10.758351325989)
...
addEvent("VenteDayZCloverLV", true)
addEventHandler("VenteDayZCloverLV", root, VenteDayZCloverLV)

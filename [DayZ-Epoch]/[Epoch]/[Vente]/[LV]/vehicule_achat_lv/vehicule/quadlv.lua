function VenteDayZQuadLV(thePlayer)
      local x, y, z = getElementPosition(thePlayer)
      veh = createVehicle(471, 2820.4860839844,1318.1414794922,10.758351325989)
...
addEvent("VenteDayZQuadLV", true)
addEventHandler("VenteDayZQuadLV", root, VenteDayZQuadLV)

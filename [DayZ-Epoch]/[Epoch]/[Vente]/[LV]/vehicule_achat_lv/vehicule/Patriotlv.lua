function VenteDayZPatriotLV(thePlayer)
      local x, y, z = getElementPosition(thePlayer)
      veh = createVehicle(470, 2820.4860839844,1318.1414794922,10.758351325989)
...
addEvent("VenteDayZPatriotLV", true)
addEventHandler("VenteDayZPatriotLV", root, VenteDayZPatriotLV)

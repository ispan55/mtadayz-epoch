function VenteDayZCamion(thePlayer)
    local x, y, z = getElementPosition(thePlayer)
    veh = createVehicle(515, -2125.7094726563,-99.714813232422,39.3203125)
    vehCol = createColSphere(-2125.7094726563,-99.714813232422,39.3203125, 4)
...
addEvent("VenteDayZCamion", true)
addEventHandler("VenteDayZCamion", root, VenteDayZCamion)

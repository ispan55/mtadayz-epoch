function VenteDayZMesa(thePlayer)
    local x, y, z = getElementPosition(thePlayer)
    veh = createVehicle(500, -2125.3696289063, -104.21908569336, 35.3203125)
...
addEvent("VenteDayZMesa", true)
addEventHandler("VenteDayZMesa", root, VenteDayZMesa)

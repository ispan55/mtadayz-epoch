function VenteDayZSanchez(thePlayer)
    local x, y, z = getElementPosition(thePlayer)
    veh = createVehicle(468, -2125.3696289063, -104.21908569336, 35.3203125)
...
addEvent("VenteDayZSanchez", true)
addEventHandler("VenteDayZSanchez", root, VenteDayZSanchez)

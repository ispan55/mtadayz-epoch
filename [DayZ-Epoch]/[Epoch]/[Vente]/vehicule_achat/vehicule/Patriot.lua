function VenteDayZPatriot(thePlayer)
    local x, y, z = getElementPosition(thePlayer)
    veh = createVehicle(470, -2125.3696289063, -104.21908569336, 35.3203125)
...
addEvent("VenteDayZPatriot", true)
addEventHandler("VenteDayZPatriot", root, VenteDayZPatriot)

function VenteDayZAdmiral(thePlayer)
    local x, y, z = getElementPosition(thePlayer)
    veh = createVehicle(445, -2125.3696289063, -104.21908569336, 35.3203125)
...
addEvent("VenteDayZAdmiralSF", true)
addEventHandler("VenteDayZAdmiralSF", root, VenteDayZAdmiral)

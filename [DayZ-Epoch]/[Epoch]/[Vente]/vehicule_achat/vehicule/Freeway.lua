function VenteDayZFreeway(thePlayer)
    local x, y, z = getElementPosition(thePlayer)
    veh = createVehicle(463, -2125.3696289063, -104.21908569336, 35.3203125)
...
addEvent("VenteDayZFreeway", true)
addEventHandler("VenteDayZFreeway", root, VenteDayZFreeway)

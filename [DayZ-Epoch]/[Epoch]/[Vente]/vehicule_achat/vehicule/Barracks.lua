function VenteDayZBarracks(thePlayer)
    local x, y, z = getElementPosition(thePlayer)
    veh = createVehicle(433, -2127.3107910156,-100.75768280029,35.3203125)
    vehCol = createColSphere(-2127.3107910156,-100.75768280029,35.3203125, 4)
...
addEvent("VenteDayZBarracks", true)
addEventHandler("VenteDayZBarracks", root, VenteDayZBarracks)

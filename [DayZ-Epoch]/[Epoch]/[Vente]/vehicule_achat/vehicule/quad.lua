function VenteDayZQuad(thePlayer)
    local x, y, z = getElementPosition(thePlayer)
    veh = createVehicle(471, -2125.3696289063, -104.21908569336, 35.3203125)
...
addEvent("VenteDayZQuad", true)
addEventHandler("VenteDayZQuad", root, VenteDayZQuad)

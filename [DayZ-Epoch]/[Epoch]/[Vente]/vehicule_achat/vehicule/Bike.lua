function VenteDayZBike(thePlayer)
    local x, y, z = getElementPosition(thePlayer)
    veh = createVehicle(509, -2125.3696289063, -104.21908569336, 35.3203125)
...
addEvent("VenteDayZBike", true)
addEventHandler("VenteDayZBike", root, VenteDayZBike)

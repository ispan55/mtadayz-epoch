function VenteDayZTractor(thePlayer)
    local x, y, z = getElementPosition(thePlayer)
    veh = createVehicle(531, -2125.3696289063, -104.21908569336, 35.3203125)
...
addEvent("VenteDayZTractor", true)
addEventHandler("VenteDayZTractor", root, VenteDayZTractor)

function VenteDayZBob(thePlayer)
    local x, y, z = getElementPosition(thePlayer)
    veh = createVehicle(554, -2125.3696289063, -104.21908569336, 35.3203125)
...
addEvent("VenteDayZBob", true)
addEventHandler("VenteDayZBob", root, VenteDayZBob)

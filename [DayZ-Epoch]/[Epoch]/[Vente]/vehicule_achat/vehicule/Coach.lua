function VenteDayZCoach(thePlayer)
    local x, y, z = getElementPosition(thePlayer)
    veh = createVehicle(437, -2127.3107910156,-100.75768280029,35.3203125)
...
addEvent("VenteDayZCoach", true)
addEventHandler("VenteDayZCoach", root, VenteDayZCoach)
